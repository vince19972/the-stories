  ...
  state: {
    ...
    care: {
      stories: [
        ...
        {
          story: 'I care about my family, because is a small one, because I left on a time of change, of duel. A time of change not only inside my family, but in my own country as a whole. So, I think about my mother and my grand-mother, even when they want me to fly my own path.'
        }
